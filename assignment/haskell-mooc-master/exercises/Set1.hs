...
distance x1 y1 x2 y2 = let x = distance1(x2 - x1) + distance1(y2-y1) in sqrt x
...
postagePrice weight = if weight > 5000 then 6000 else if weight <= 500 then 250 else  300 + weight 
