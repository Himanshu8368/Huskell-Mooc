...
-- Implement instances of Price for Egg
instance Price Egg where
    price ChickenEgg = 20
    price ChocolateEgg = 30

-- Implement instance of Price for Milk
...
-- Implement instance of Price for Egg
instance Price Egg where
    price ChickenEgg = 20
    price ChocolateEgg = 30
...
-- Implement instance of Price for Maybe a
instance Price a => Price (Maybe a) where
    price Nothing = 0
    price (Just x) = price x

-- Implement instance of Price for [a]
...
simplify (RationalNumber a b)
  ...
  | otherwise = let common = gcd' a b
                in RationalNumber (a `div` common) (b `div` common)
