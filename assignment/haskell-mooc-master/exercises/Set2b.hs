...
smallestDivisor n = smallestDivisorFrom 2 n

smallestDivisorFrom :: Integer -> Integer -> Integer
smallestDivisorFrom k n
  | n `mod` k == 0 = k
  | otherwise      = smallestDivisorFrom (k + 1) n
...
biggestPrimeAtMost n
  | n < 2     = error "No prime number less than 2"
  | isPrime n = n
...
-- Function to find the smallest divisor of a number greater than 1
smallestDivisor :: Integer -> Integer
smallestDivisor n = smallestDivisorFrom 2 n

-- Helper function to find the smallest divisor starting from a given number
smallestDivisorFrom :: Integer -> Integer -> Integer
smallestDivisorFrom k n
  | n `mod` k == 0 = k
  | k * k > n      = n
